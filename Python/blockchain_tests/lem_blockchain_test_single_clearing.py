...
def test_clearings():
    ...
    for i in iterations:
        ...
        tx_hash = blockchain_utils.functions.single_clearing(t_clearing_current, supplier_bids, uniform_pricing,
                                                             ...
                                                             verbose, False).transact({'from': blockchain_utils.coinbase})
...
#got the results from the blockchain, I reformat the data to get a dataframe with the same shape as the one given in input
